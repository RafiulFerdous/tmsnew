...
import '../css/all.css';
import Opendingcod from '../../Model/operation_content/Ocodpending';
...
const Opending =() =>{
  ...
  useEffect(()=>{
    ...
    var config = {
      method: 'post',
      url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/product_COD_Status'+'?company_name='+company_name : '/universalapi/allapi/product_COD_Status'+'?company_name='+company_name,
      headers: { 
        ...
        <>
          ...
          <div className="row">
            ...
            <div className="row container">
                            ...
                            {
                                      payload ? <Opendingcod response={information}/> : 
