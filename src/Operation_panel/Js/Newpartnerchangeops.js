...
import Newpartnerchangetableops from "../../Model/operation_content/Newpartnerchangetableops";
import "../css/all.css";
        ...
        <div className="container">
          <div className="col-12" id="">
            ...
            {isLoading ? (
              ...
              <Newpartnerchangetableops response={information} />
            ) : (
              <></>
            )}
            {/*&&information===""*/}
...
export default Newpartnerchangeops;
