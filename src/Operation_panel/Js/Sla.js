...
import Slacontent from '../../Model/operation_content/Slacontent';
import '../css/all.css';
...
let extendday, setextendday;
let waybil, setwaybill;

const Sla=() =>{
  const [employid,setemployid] = React.useState('');
  const [extendday,setextendday] = React.useState('');
  ...
  useEffect(()=>{
    ...
    var config = {
      method: 'post',
      url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/deleverySLA'+'?company_name='+company_name : '/universalapi/allapi/deleverySLA'+'?company_name='+company_name,
      headers: { 
        ...
        <>
          ...
          <div className="row">
            ...
            <div className="row container">
                            ...
                            {
                                      payload ? <Slacontent response={information}/> : 
