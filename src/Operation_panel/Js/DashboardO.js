...
import DashboardOps from "../../Model/operation_content/DashboardOps";
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/operation_allproductInformation" +
          "?company_name=" +
          company_name
      ...
      <div className="bodydiv">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5 d-flex" id="">
            {payload ? (
              <DashboardOps response={information} />
            ) : (
