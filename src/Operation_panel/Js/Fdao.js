...
import '../css/all.css';
import Ofdatable from '../../Model/operation_content/OFDA';
...
const OFda =() =>{
  ...
  useEffect(()=>{
    ...
    var config = {
      method: 'post',
      url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/firstOrderAttempt'+'?company_name='+company_name : '/universalapi/allapi/firstOrderAttempt'+'?company_name='+company_name,
      headers: { 
        ...
        <>
          ...
          <div className="row">
            ...
            <div className="row container">
                            ...
                            {
                                      payload ? <Ofdatable response={information}/> : 
