...
import Operationsupport from '../../Model/operation_content/SupportOperation';
...
const Support =() =>{
  ...
  useEffect(()=>{
    ...
    var config = {
      method: 'post',
      url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/operationPanel_customerSupport'+'?company_name='+company_name : '/universalapi/allapi/operationPanel_customerSupport'+'?company_name='+company_name,
      headers: { 
        ...
        <>
          ...
          <div className="row">
            ...
            <div className="row container">
                            ...
                            {
                                      payload ? <Operationsupport response={information}/> : 
