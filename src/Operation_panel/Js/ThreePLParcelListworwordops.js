...
import ThreePLParcelListworwordtableops from "../../Model/operation_content/ThreePLParcelListworwordtableops";
...
const ThreePLParcelListworwordops = () => {
      ...
      <div className="bodydiv">
        ...
        <div className="mt-5 pt-5">
          <div className="col-12  pt-5" id="">
            ...
            {payload ? (
              <ThreePLParcelListworwordtableops response={information} />
            ) : (
...
export default ThreePLParcelListworwordops;
