...
const Unconfirmpaymentdctable = (props) => {
  ...
  //         });
  // }
  console.log("all data", alldata[0]?.final_response);
    ...
    <>
      ...
      >
        ...
        <tbody className="text-center border border-secondary">
          {alldata[0]?.final_response &&
            alldata[0]?.final_response.map((single_day_information) => {
              ...
              total =
                delevered_number + holded_number + return_number + lost_number;
...
export default Unconfirmpaymentdctable;
