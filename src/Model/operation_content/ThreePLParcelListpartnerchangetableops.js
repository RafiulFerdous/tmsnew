...
const ThreePLParcelListpartnerchangetableops = (props) => {
  ...
  const partnerchange = () => {
    ...
    if (filterClientforpartnerchange !== "None") {
    ...
    currentPageData &&
      currentPageData.map((single_product_information, list_index) => {
        if (check_box_flag_state[list_index]) {
          ...
          pdf.addImage(img.src, "WEBP", 35, 53, 35, 12);
  ...
  //             pdf.text(
  //                 "Date: " +
  //                 single_product_information.product_entry_date_time.split("T")[0],
  //                 70,
  //                 25,
  //                 { maxWidth: 50 },
  //                 0
          ...
          >
            ...
            <div className="row mb-3">
              <div className="col-lg-6 col-md-6 col-12 mb-2">
                ...
                //   }}
                >
                  <label htmlFor="PartnerChange">Partner Change Select</label>
                  <select
                    name=""
                    id="PartnerChange"
                    style={{
...
export default ThreePLParcelListpartnerchangetableops;
