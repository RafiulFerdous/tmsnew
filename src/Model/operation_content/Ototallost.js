...
const Ototallosttable = (props) => {
    ...
    React.useEffect(() => {
      const users1 =  json_information.message.lost_product_information.filter(p =>
...
export default Ototallosttable;