...
export const Bagtable = (props) => {
    const [allbag, setallbag] = useState([]);
    let json_table = props.response;
    console.log("allbag in table", allbag);
    console.log("json_table", json_table);
    useEffect(() => {
        setallbag(json_table.message);
    }, [json_table]);
    ...
    return (
        <div>
            ...
            <div className="container" id="tablebag">
                <CSVLink
                    filename={`BagList${getCurrentTime()}.xls`}
                    data={allbag}
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td data-title="Created Employee ID">
                                                <Link className="btn btn-sm px-3 btn-outline-success"
                                                    to={{
                                                        pathname: "/product",
                                                        state: {
