...
const Hometabledc = (props) => {
    toast.configure();
    const [assignedbag, setassignedbag] = useState([]);
    ...
    useEffect(() => {
        console.log(
            "bag list",
            json_information.message.concat(json_information.return_bag_list)
        );
        setassignedbag(
            json_information.message.concat(json_information.return_bag_list)
        );
    ...
    useEffect(() => {
        ...
        const users1 = json_information.message
            .concat(json_information.return_bag_list)
            .filter(
                (p) =>
        ...
        setassignedbag(users1);
    }, [searchTerm]);

    console.log("this is dc assign bag", assignedbag);
    return (
        <>
          ...
          welcome to {logingInformation_LocalStore.all_user_list.employeE_ZONE}
                ...
                <div className="row my-2">
                    ...
                    <div className="col-8 col-lg-6 col-md-7">
                        {" "}
                        <input
                            type="text"
                ...
                <div id="no-more-tables">
                    {/* <div className="container p-3" id="dchome">
            <form>
              <p>
                welcome to{" "}
                ...
                <div className="col-12 d-flex justify-content-center text-align-center">
                  ...
                  >
                    ...
                    <div className="mt-4 pt-4">
                        ...
                        <div className="d-flex mt-4 my-2">
                            <CSVLink
                                data={assignedbag}
                    ...
                    >
                        ...
                        <tr className="text-dark" style={{ border: "none" }}>
                            ...
                            <th>PACKAGES</th>
                            <th>Total VALUE</th>
                            <th>CREATION CENTER</th>

                            <th>DESTINATION CENTER</th>
                            <th>baG_VEHICLE_ID</th>
                            <th>bag TYPE</th>
                        ...
                        {assignedbag.map((single_message) => {
                            return (
                                <>
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Pin Code">{single_message.baG_TYPE}</td>
