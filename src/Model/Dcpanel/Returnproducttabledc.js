...
const Returnproducttabledc =(props) =>{
    ...
    */
    ...
    useEffect(()=>{
        ...
        if(productWaybill.length > 0){
            ...
            var config = {
                method: 'post',
                url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/removeProductfromBag'+'?company_name='+company_name : '/universalapi/allapi/removeProductfromBag'+'?company_name='+company_name,
                headers: {
                ...
                <div className="col-12">
                    <div className=" container table-responsive">
                        <table id="table">
                            ...
                            {
                                //product_information
                                pageRefreshFlag ? json_product.product_information.map(single_message => {
                                    return(
                                        <tr key= {single_message.waybill_number}>
                                            <td >
                                                <button className="btn btn-success btn-small" onClick={()=>bagRemoveButton(single_message.waybill_number)}>Remove</button>
                                            </td>
...
export default Returnproducttabledc