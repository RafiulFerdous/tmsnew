...
import "../Processingcenter/modal.css";
...
const Returnbagtable = (props) => {
    let json_table = props.response;

    //console.log("This is json_table reroute data", json_table);
    ...
    return (
        <div>
            ...
            <div className="container mt-5 pt-5" id="tablebag">
                <div>
                            ...
                            {json_table.message.map((single_message) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td data-title="DC ID & Description">
                                        ...
                                        <td data-title="Created Employee ID">
                                            <Link
                                                to={{
                                                    pathname: "/productreturndc",
                                                    state: {
                                                        fromNotifications: single_message.baG_ID_NUMBER,
                                                        bagway: single_message.baG_WAYBILL_NUMBER,
                                                    },
                                                }}
                                            >
            ...
            <div className="invoice w-75 mt-5 pt-5" ref={wrapper_ref}>
