...
import Receiveparcelfetable from '../../Model/Fe_panel/Receiveparcelfetable'
...
import {Linksidebar,fepanel,CustomerCareLinksidebar,Salessidebar,Operationsidebar,Degital_Ocean_flag,company_name,dcpanel,superadminsidebar} from '../../Common/Linksidebar';
import Receivedbagtabledc from '../../Model/Dcpanel/Receivedbagtabledc';
...
export default function Receiveparcelfe() {
    ...
    useEffect(()=>{
        ...
        if(context_flag_obj == undefined){
            ...
            else if(context_flag_obj.all_user_list.employeE_DEGIGNATION == employee_degignation_list.FieldExecutive)
            {
                setsiteBarInformation_LocalStore(fepanel);
                final_sideBar = fepanel;//useState a set kore rakhlam
            }
    ...
    useEffect(()=>{
        ...
        let data = JSON.stringify({
            "Field_operative_id": logingInformation_LocalStore.all_user_list.employeE_ID,
            "date_time": getCurrentTime()
        });
        var config = {
            method: 'post',
            url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/getProductbyFe'+'?company_name='+company_name : '/universalapi/allapi/getProductbyFe'+'?company_name='+company_name,
            headers: {
        ...
        axios(config)
            ...
            .then(res => {
                console.log("response is recvd",res);
                setinformation(res);
                setpayload(true);
            })
            ...
            <div className="bodydiv">
                ...
                <div className="row container">
                    <div className="col-12 d-flex" id="menuhome">
                        {payload ? <Receiveparcelfetable response={information}/> :
