...
import Parceldeliverytable from "../../Model/Fe_panel/Parceldeliverytable";
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/getConfirmProductbyFe" +
          "?company_name=" +
          company_name
        : "/universalapi/allapi/getConfirmProductbyFe" +
          "?company_name=" +
          company_name,
      headers: {
    ...
    axios(config)
      ...
      .then((res) => {
        console.log("response is parcel delivery product", res);
        setinformation(res);
        setpayload(true);
      })
      ...
      <div className="bodydiv">
        ...
        <div className="row container">
          <div className="col-12 d-flex" id="menuhome">
            {payload ? (
              <Parceldeliverytable response={information} />
            ) : (
