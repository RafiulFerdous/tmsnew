...
const Returnedpcreceivedbag = () => {
    ...
    useEffect(() => {
        ...
        var config = {
            method: 'post',
            url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/pcReceiveddBag' + '?company_name=' + company_name : '/universalapi/allapi/pcReceiveddBag' + '?company_name=' + company_name,
            headers: {
            ...
            <div className="bodydiv">
                ...
                <div className="row container">
                    <div className="col-12 d-flex" id="menuhome">
                        {payload ? <Returnedpcreceivedbagtable response={information} /> :
