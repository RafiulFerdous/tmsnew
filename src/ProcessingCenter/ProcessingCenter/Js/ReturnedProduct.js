...
import Picktable from '../../Model/Processingcenter/Picktable';
...
import ReturnedProductTable from '../../Model/Processingcenter/ReturnedProductTable';
...
export default function ReturnedProduct() {
    ...
    useEffect(()=>{
        var data = JSON.stringify({
            "district_in_charge_id": logingInformation_LocalStore.all_user_list.employeE_ID
           
            });
            console.log(data)
        var config = {
         method: 'post',
         url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/getReturnedProductinPc'+'?company_name='+company_name : '/universalapi/allapi/getReturnedProductinPc'+'?company_name='+company_name,
          headers: { 
        ...
        <div className="bodydiv">
          ...
          <div className="row container">
                            <div className="col-12 d-flex" id="menuhome">
                                 {payload ? <ReturnedProductTable response={information}/> : 
