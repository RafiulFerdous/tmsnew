...
export default function ReturnPcBag() {
    ...
    useEffect(()=>{
        ...
        var config = {
         method: 'post',
         url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/pcAssignedBag'+'?company_name='+company_name : '/universalapi/allapi/pcAssignedBag'+'?company_name='+company_name,
          headers: { 
        ...
        <div className="bodydiv">
          ...
          <div className="row container">
                            <div className="col-12 d-flex" id="menuhome">
                                 {payload ? <ReturnPcBagTable response={information}/> : 
