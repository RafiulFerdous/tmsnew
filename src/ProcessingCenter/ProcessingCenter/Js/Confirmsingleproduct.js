...
import Singleproducttable from '../../Model/Processingcenter/Singleproducttable'
import '../css/all.css';
...
const Confirmsingleproduct =() =>{
  ...
  useEffect(()=>{
   ...
   console.log(siteBarInformation_LocalStore);
    var config = {
      method: 'post',
      url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/pcPanelSingleProductWaitingtobeConfirmed'+'?company_name='+company_name : '/universalapi/allapi/pcPanelSingleProductWaitingtobeConfirmed'+'?company_name='+company_name,
      headers: { 
          ...
          <div className="row">
            ...
            <div className="row container">
                            <div className="col-12 d-flex" id="menuhome">
                                 {payload ? <Singleproducttable response={information}/> : 
...
export default Confirmsingleproduct;