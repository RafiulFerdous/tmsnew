...
import Partnerreturntable from "../../Model/Processingcenter/Partnerreturntable";
import "../css/all.css";
...
const Partnerreturn = () => {
  ...
  useEffect(() => {
    ...
    axios(config)
      ...
      .then((res) => {
        console.log("this is partner courer list", res);
      ...
      <div className="bodydiv">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5" id="menuhome">
            <Partnerreturntable response={information} />
            {/* {payload ? (
                        ) : (
