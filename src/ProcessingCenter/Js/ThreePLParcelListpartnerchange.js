...
import ThreePLParcelTable from "./ThreePLParcelTable";
import ThreePLParcelListpartnerchangetable from "../../Model/Processingcenter/ThreePLParcelListpartnerchangetable"
...
const ThreePLParcelListpartnerchange = () => {
    ...
    useEffect(() => {
        ...
        var config = {
            ...
            url: Degital_Ocean_flag
                ? "https://e-deshdelivery.com/universalapi/allapi/partnerDeliverycompanyProductList" +
                "?company_name=" +
                company_name
            ...
            <div className="bodydiv">
                ...
                <div className="mt-5 pt-5">
                    <div className="col-12  pt-5" id="">
                        ...
                        {payload ? (
                            <ThreePLParcelListpartnerchangetable response={information}/>
                        ) : (
...
export default ThreePLParcelListpartnerchange;
