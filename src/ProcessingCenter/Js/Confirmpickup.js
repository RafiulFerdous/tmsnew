...
import Confirmpickuptable from "../../Model/Processingcenter/Confirmpickuptable";
import "../css/all.css";
...
const Confirmpickup = () => {
  ...
  useEffect(() => {
    ...
    axios(config)
      ...
      .then((res) => {
        console.log("This is res of client name", res);
        setinformation(res.message.all_client_name);
        setpayload(true);
      })
    ...
    <>
      <div className="bodydiv">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5" id="menuhome">
            {payload ? (
              <Confirmpickuptable response={information} />
            ) : (
