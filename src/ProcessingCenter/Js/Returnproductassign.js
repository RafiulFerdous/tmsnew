...
import { Returnproductassigntable } from '../../Model/Processingcenter/Returnproductassigntable';
...
const Returnproductassign =() =>{
    ...
    try{
        ...
        returnwaybill = location.state.returnway;
    }catch(e){
        history.push("/Returnbagcreation");
    }
    // const myparam = location.state.fromNotifications;
    ...
    let insertProductinBagSubmitButtonFunction = (e) => {
        ...
        console.log("type of bag id", typeof(myparam))
        //end of conversion............................
    ...
    useEffect(()=>{
        ...
        var config = {
            method: 'post',
            url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/insertReturnProductinBagPC'+'?company_name='+company_name : '/universalapi/allapi/insertReturnProductinBagPC'+'?company_name='+company_name,
            headers: {
            ...
            <div className="bodydiv">
                ...
                <div className="row container">
                    <div className="col-12" id="bgcrt">
                            ...
                            <div className="container p-3">
                                <form>
                                    <div className="form-group row mb-2">
                                        ...
                                        {/*    onChange={(e)=>{ setstrProductWaybillList(e.target.value) }}*/}
                                        </div>
                                    </div>

                                    <div className="form-group row mb-2">
                                        <label htmlFor className="col-sm-3 col-form-label">Count:{count} </label>

                                    </div>

                                    <div className="form-group row mb-2">
                                        <label htmlFor className="col-sm-3 col-form-label">
                                            Bag Waybill: {returnwaybill}
                                        </label>
                                    </div>
                                    <div className="row">
                        ...
                        {payload ? <Returnproductassigntable response={information}/> :
...
export default Returnproductassign;