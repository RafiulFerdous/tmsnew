...
const Confirmpayment = () => {
  ...
  //   var config = {
  //     method: 'post',
  //     url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/accountPanelReceivePaymentProductListFromDC'+'?company_name='+company_name : '/universalapi/allapi/accountPanelReceivePaymentProductListFromDC'+'?company_name='+company_name,
  //     headers: {
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/getAllClientName" +
          "?company_name=" +
          company_name
        : "/universalapi/allapi/getAllClientName" +
          "?company_name=" +
          company_name,
      headers: {
        "Content-Type": "application/json",
      ...
      <div className="">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5 d-flex" id="">
            {payload ? (
              <Confirmpaymenttable response={information} />
            ) : (
