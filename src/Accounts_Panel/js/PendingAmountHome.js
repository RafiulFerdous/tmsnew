...
import PendingAmountHomeTable from "../../Model/Accounts/PendingAmountHomeTable";
import "../css/all.css";
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/accountPanelPandingAmountInDC" +
          "?company_name=" +
          company_name
      ...
      <div className="">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5 d-flex" id="">
            {payload ? (
              <PendingAmountHomeTable response={information} />
            ) : (
...
export default PendingAmountHome;
