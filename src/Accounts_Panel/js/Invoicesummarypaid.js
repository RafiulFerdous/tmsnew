...
import InvoiceSummarypaidtable from "../../Model/Accounts/Invoicesummarypaidtable";
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/accountPanelallInvoiceSummaryPaid" +
          "?company_name=" +
          company_name
      ...
      <div className="">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5 d-flex" id="">
            {payload ? (
              <InvoiceSummarypaidtable response={information} />
            ) : (
...
export default InvoiceSummarypaid;
