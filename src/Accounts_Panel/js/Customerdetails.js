...
import {Linksidebar,CustomerCareLinksidebar,Salessidebar,Operationsidebar,acsidebar,Degital_Ocean_flag} from '../../Common/Linksidebar';
import {LoginContext} from '../../Context/loginContext';
import axios from 'axios';
import Employelisttable from '../../Model/Hr_content/Employeelisttable'
...
const CustomerDetails =() =>{
  ...
  useEffect(()=>{
    ...
    if(context_flag_obj == undefined){
      if(loginInformation.all_user_list.employeE_DEGIGNATION == employee_degignation_list.Finance)
      {
      ...
      if(context_flag_obj.all_user_list.employeE_DEGIGNATION == employee_degignation_list.Finance)
      {
          setsiteBarInformation_LocalStore(acsidebar);//useState a set kore rakhlam.
      }
