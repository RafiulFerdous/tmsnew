...
import {Linksidebar,CustomerCareLinksidebar,Salessidebar,Operationsidebar,Hrsidebar,Degital_Ocean_flag} from '../../Common/Linksidebar';
...
const Employeelist =() =>{
  ...
  useEffect(()=>{
    ...
    if(context_flag_obj == undefined){
      if(loginInformation.all_user_list.employeE_DEGIGNATION == employee_degignation_list.Admin)
      {
      ...
      if(context_flag_obj.all_user_list.employeE_DEGIGNATION == employee_degignation_list.Admin)
      {
          setsiteBarInformation_LocalStore(Hrsidebar);//useState a set kore rakhlam.
      }
