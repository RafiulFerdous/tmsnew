                            ...
                            {getAllLocation?.map((single_message) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td data-title="">
                                            {single_message.hubName}
                                        </td>
                                        <td data-title="">
                                            {single_message.isActive===true?"Active":"Inactive"}
                                        </td>
                                        <td data-title="" className="btn btn-sm btn-outline-warning" 
                                        // onClick={(e)=>submit(e,single_message.hubId,single_message.isActive)}
                                        >
                                            Change Status
                                        </td>
