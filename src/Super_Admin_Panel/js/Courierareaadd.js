...
const Courierareaadd = () => {
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://api-hermes.pathaointernal.com/aladdin/api/v1/countries/1/city-list"
        : "http://api-hermes.pathaointernal.com/aladdin/api/v1/countries/1/city-list",
      headers: {
    ...
    axios(config)
      .then((res) => {
         console.log("getall city", res);
         setrootcity(res?.data?.data);
        // setIsLoading(false);
      })
  ...
  console.log("get all city",rootcity)
  const resetInput = () => {
    setThana("");
    setDistrict("");
    setDivision("");
  ...
  const handleSubmit = (e) => {
    ...
    let config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/api/v1.1/Location/CreateLocation"
        : "http://test.e-deshdelivery.com/api/v1.1/Location/CreateLocation",
      headers: {
        "Content-Type": "application/json",
      },
      data: data,
  ...
  const handleCityChange = (event) => {
    ...
    var config = {
      method: "get",
      url: Degital_Ocean_flag
        ? "https://api-hermes.pathaointernal.com/aladdin/api/v1/cities/36/zone-list"
        : "https://api-hermes.pathaointernal.com/aladdin/api/v1/cities/36/zone-list",
      headers: {
        "Content-Type": "application/json",
      },
            ...
            <div className="row">
                {/* <div className="col-lg-3 col-md-6">
                    <div className="form-group mb-3">
                        <label htmlFor="simpleinput"> Name</label>
                        <input
                ...
                <div className="col-lg-3 col-md-6">
                    <div className="form-group mb-3">
                        <label htmlFor="simpleinput">Select City</label>
                        <select
                            className="form-control"
                            id="example-select"
                            name="type"
                        ...
                        >
                            ...
                            {rootcity?.map((typee) => (
                                  <option key={typee.city_id} value={typee.city_id}>
                                        {typee.city_name}{" "}
                                  </option>
                            ))}
                        </select>
                ...
                <div className="col-lg-3 col-md-6">
                    <div className="form-group mb-3">
                        <label htmlFor="simpleinput">Select Zone</label>
                        <select
                            className="form-control"
                            id="example-select"
                            name="type"
                ...
                <div className="col-lg-3 col-md-6">
                    <div className="form-group mb-3">
                        <label htmlFor="simpleinput">Select Area</label>
                        <select
                            className="form-control"
                            id="example-select"
                            name="type"
                    ...
                    <div className="col-lg-12">
                      <form onSubmit={handleSubmit}>
                        <div className="row">
                            ...
                            <div className="form-group mb-3">
                                <label for="simpleinput">Select City</label>
                                <select
                                className="form-control "
                                id="example-select"
                                name="type"
