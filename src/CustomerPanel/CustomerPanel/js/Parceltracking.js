...
import Cperceltracking from '../../Model/Customer_content/Cperceltracking'
...
const Parceltracking =() =>{
  ...
  useEffect(()=>{
    ...
    if(context_flag_obj == undefined){
      ...
      console.log("value set up if: ",loginInformation.all_user_list_Client.customeR_ID);
    }
    else {
      ...
      console.log("value set up else : ",context_flag_obj.all_user_list_Client.customeR_ID);
    }
        ...
        <>
          ...
          <div className="row">
            ...
            <div className="row container-fluid">
                            ...
                            {
                                      payload ? <Cperceltracking response={information}/> : 
