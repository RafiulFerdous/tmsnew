...
import Paymentconfirmtable from "../../Model/Customer_content/Paymentconfirmtable";
import {
  Linksidebar,
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/clientPanelProductPaymentWaitingtobeConfirmed" +
          "?company_name=" +
          company_name
        ...
        <div>
          ...
          <div className="container mt-5 pt-5">
            <div className="col-12 d-flex pt-5" id="">
              {payload ? (
                <Paymentconfirmtable response={information} />
              ) : (
