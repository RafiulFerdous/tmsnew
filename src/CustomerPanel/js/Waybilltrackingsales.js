...
import "../../Sales_panel/css/all.css";
...
const Waybilltrackingsales = () => {
  ...
  //     //logingInformation_LocalStore.all_user_list_Client.customeR_ID
              ...
              <div className="col-lg-6 col-md-6 col-sm-4 form-group mx-3 mt-2 p-4">
                <div className="input-group  input-icons">
                  ...
                  <input
                    ...
                    name=""
                    id=""
                    placeholder="Type Waybill or Mobile or OrderID here"
              ...
              <div className="d-flex">
                <div className="order-track shadow p-3 mb-5 bg-white rounded m-auto modal-width">
                  <div className="d-flex justify-content-between">
                    <h4>Details Info </h4>
                    <span className="text-end border border-2 border-success rounded-3 bg-success text-white px-2">
                      {productinfo.product_infor &&
                  ...
                  <h6>
                    <span className="badge bg-secondary">Consignee Number</span>
                    :
                    {productinfo.product_infor &&
                  ...
                  <h6>
                    ...
                    :
                    {productinfo.product_infor &&
                      productinfo.product_infor.address}
                  </h6>
                  <h6>
                    <span className="badge bg-secondary">Payment Type</span>:
                    {productinfo.product_infor &&
                      productinfo.product_infor.producT_PAYMENT_TYPE}
                  </h6>
                  <h6>
                    <span className="badge bg-secondary">Payment Weight</span>:
                    {productinfo.product_infor &&
                      productinfo.product_infor.producT_WEIGHT}
                  </h6>
                  <h6>
                    <span className="badge bg-secondary">COD Amount</span>:
                    {productinfo.product_infor &&
...
export default Waybilltrackingsales;
