...
import Unconfirmlisttable from "../../Model/Customer_content/Unconfirmlisttable";
//import '../css/allc.css';
...
const Unconfirmlist = () => {
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/clientPanelseeProductwaitingtobeConfirmed" +
          "?company_name=" +
          company_name
    ...
    console.log("data inform;ation is ; : ", config);
    axios(config)
      ...
      .then((res) => {
        console.log("this is unconfirm list res", res);
        setinformation(res.message.all_product_information);
        setpayload(true);
      })
  ...
  console.log("this is unconfirm list info", information);
  ...
  return (
    <>
      <div>
        ...
        <div className="mt-5 pt-5 container col-12">
          <div className="col-12 pt-5 d-flex" id="">
            {
              //
              payload ? (
                <Unconfirmlisttable response={information} />
              ) : (
