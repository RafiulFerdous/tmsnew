...
const Support = () => {
  ...
  let bagCreationSubmitButtonFunction = (e) => {
    ...
    var data = JSON.stringify({
      clienT_NAME:
      logingInformation_LocalStore?.all_user_list_Client?.customeR_NAME,
      clienT_EMAIL:
      logingInformation_LocalStore?.all_user_list_Client?.customeR_EMAIL,
      clienT_CONTACT_NUMBER:
      logingInformation_LocalStore?.all_user_list_Client
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
          ? "https://e-deshdelivery.com/universalapi/allapi/clientQueryRequest" +
          "?company_name=" +
          company_name
          : "/universalapi/allapi/clientQueryRequest" +
          "?company_name=" +
          company_name,
      headers: {
      ...
      <>
        <div className="l bodydiv">
          ...
          <div className="mt-5 pt-5  d-flex justify-content-center">
            <div className="w-75 bg-dark rounded-3" id="">
              <div className="row my-3">
                <div className="col text-center mb-4">
                  <h2 className="text-white" id="">
                    Contact Us
                  </h2>
                </div>
                <div className="row d-flex justify-content-center">
                  <form className="col-lg-8 col-md-8 col-sm-4 form-group mx-3 mt-2 p-4">
                    <div className="form-group row">
                      <label
                          htmlFor="fname"
                          className="col-sm-3 mb-3 col-form-label text-white "
                      >
                        <h6>Client Name:</h6>
                      </label>
