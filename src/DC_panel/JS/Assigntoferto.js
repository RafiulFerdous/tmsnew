...
import Assigntofertotable from "../../Model/Dcpanel/Assigntofertotable";
// import '../css/all.css';
    ...
    useEffect(() => {
        ...
        var config = {
            ...
            url: Degital_Ocean_flag
                ? "https://e-deshdelivery.com/universalapi/allapi/getReturnProductinDc" +
                "?company_name=" +
                company_name
                : "/universalapi/allapi/getReturnProductinDc" +
                "?company_name=" +
                company_name,
            headers: {
            ...
            <div className="bodydiv">
                ...
                <div className="mt-5 pt-5 container">
                    <div className="" id="menuhome">
                        {payload ? (
                            <Assigntofertotable response={information} />
                        ) : (
