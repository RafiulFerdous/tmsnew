    ...
    useEffect(() => {
        ...
        var config = {
            ...
            url: Degital_Ocean_flag
                ? "https://e-deshdelivery.com/universalapi/allapi/dcAssignedBag" +
                "?company_name=" +
                company_name
                : "/universalapi/allapi/dcAssignedBag" +
                "?company_name=" +
                company_name,
            headers: {
        ...
        axios(config)
            ...
            .then((res) => {
                console.log("response is dc assign", res);
                setinformation(res);
                setpayload(true);
            })
        ...
        <>
            <div className="bodydiv">
                ...
                <div className="container">
                    <div className="" id="">
                        {payload ? (
                            <Hometabledc response={information} />
                        ) : (
