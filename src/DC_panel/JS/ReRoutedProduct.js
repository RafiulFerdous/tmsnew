...
import ReRoutedProductTable from "../../Model/Dcpanel/ReRoutedProductTable";
...
export default function ReRoutedProduct() {
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/gettingReroutedProductbyDC" +
          "?company_name=" +
          company_name
        : "/universalapi/allapi/gettingReroutedProductbyDC" +
          "?company_name=" +
          company_name,
      headers: {
  ...
  return (
    <>
      <div className="bodydiv">
        ...
        <div className="pt-5 mt-5 container" id="reroutepro">
          <div className="col-12 pt-5 d-flex" id="">
            {payload ? (
              <ReRoutedProductTable response={information} />
            ) : (
