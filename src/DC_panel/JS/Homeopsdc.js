...
import Homeopsdctable from "../../Model/Dcpanel/Homeopsdctable";
import "../../Operation_panel/css/all.css";
    ...
    return (
        <>
                        ...
                        >
                                ...
                                <div className="col-lg-5 col-md-12 col-12 my-3">
                                    ...
                                    <div className="mt-2">
                                        <div className="d-flex justify-content-between my-1">
                                            ...
                                            {unattamptStutus && unattamptStutus ? (
                          ...
                          {unattamptStutus?.length}
                                        ...
                                        <div className="d-flex justify-content-between my-1">
                                            ...
                                            {DeliveredStutus && DeliveredStutus ? (
                                                <span className="m-0 fw-bold">
            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6 col-12 d-flex my-4">
                <div className="m-auto" id="card">
                  <div className="">
                    {" "}
                    <a
                  ...
                  <div className="mt-2">
          ...
          </div> */}
                    {
                        isLoading ? (
                            ...
                            <Homeopsdctable response={information} />
                        ) : (
                            <></>
                        )
