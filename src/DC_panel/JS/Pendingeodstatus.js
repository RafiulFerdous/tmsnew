...
import PendingEodTable from "../../Model/Dcpanel/PendingEodTable";
...
const Pendingeodstatus = () => {
    ...
    console.log("this is pendingeod status information", information);
        ...
        <>
            <div className="bodydiv">
                ...
                <div className="container">
                    <div className="col-12 mt-5 pt-4" id="menuhome">
                        {payload ? (
                            <PendingEodTable response={information} />
                        ) : (
...
export default Pendingeodstatus;
