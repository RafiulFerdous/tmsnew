...
import Returnbagtable from "../../Model/Dcpanel/Returnbagtable";
...
const Returnbag = () => {
  ...
  console.log("this is bagcreationcenter", bagCreationCenter);
  ...
  let bagCreationSubmitButtonFunction = (e) => {
    ...
    var data = JSON.stringify({
      ...
      Bag_Destination_Center: "Tongi Pc",
      Bag_Description: bagDescription,
      dateTime: getCurrentTime(),
      bagCreatedByEmployeeID:
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/returnBagCreationByDC" +
          "?company_name=" +
          company_name
        : "/universalapi/allapi/returnBagCreationByDC" +
          "?company_name=" +
          company_name,
      headers: {
    ...
    console.log("config data for return bag", config);
    console.log("config data for return bag", config);
  ...
  useEffect(() => {
    ...
    console.log("Loging Users : ", logingInformation_LocalStore);
  }, [logingInformation_LocalStore]);
  ...
  useEffect(() => {
    ...
    var config = {
      method: "post",
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/allReturn_bag_informationInDC" +
          "?company_name=" +
          company_name
  ...
  console.log("all return bag information", information);
      ...
      <div className="bodydiv">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5" id="">
            ...
            >
              <h3 className="text-center mt-3">Bag Creation</h3>
                ...
                <form className>
                  ...
                  <div className="form-group row mb-2">
                    ...
                    <div className="col-sm-6 position-relative">
                      ...
                      />
                      <datalist id="dcnames">
                        <option value="Tongi Pc" selected></option>
                        {/* {
                                                    DistrictNamePayload && DistrictNameinformation.message.all_dc_name.map(single_dc_office_name => {
                                                        return(
                                                            <option value={single_dc_office_name}>{single_dc_office_name}</option>
                                                        );
                                                    })
                                                } */}
                      </datalist>
