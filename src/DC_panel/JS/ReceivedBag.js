...
export default function ReceivedBag() {
    ...
    useEffect(() => {
        ...
        console.log("this is received bag in dc",data)
        var config = {
            method: "post",
            url: Degital_Ocean_flag
                ? "https://e-deshdelivery.com/universalapi/allapi/dcReceiveddBag" +
                "?company_name=" +
                company_name
                : "/universalapi/allapi/dcReceiveddBag" +
                "?company_name=" +
                company_name,
            headers: {
            ...
            <div className="bodydiv">
                ...
                <div className=" container">
                    <div className="" id="menuhome">
                        {payload ? (
                            <Receivedbagtabledc response={information} />
                        ) : (
