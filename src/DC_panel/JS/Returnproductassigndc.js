...
import Returnproducttabledc from "../../Model/Dcpanel/Returnproducttabledc";
...
const Returnproductassigndc = () => {
  ...
  try {
    ...
    bagwaybill = location.state.bagway;
  } catch (e) {
    history.push("/Returnbag");
  }
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/insertReturnProductinBagDC" +
          "?company_name=" +
          company_name
        : "/universalapi/allapi/insertReturnProductinBagDC" +
          "?company_name=" +
          company_name,
      headers: {
  ...
  useEffect(() => {
    ...
    var config = {
      method: "post",
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/bagReturnProductInformationForDC" +
          "?company_name=" +
          company_name
  ...
  const truckIcon = <FontAwesomeIcon icon={faSearch}></FontAwesomeIcon>;
  return (
    <>
      <div className="bodydiv">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5" id="">
            ...
            {payload ? (
              <Returnproducttabledc response={information} />
            ) : (
...
export default Returnproductassigndc;
