...
import Vehicle1dc from "../../Model/Dcpanel/Vehicle1dc";
...
import Pltabledc from "../../Model/Dcpanel/Pltabledc";
          ...
          <div className="col-12 pt-5" id="">
            ...
            <div className="row p-0 m-0">
              <div className="col-lg-6 col-md-8 col-12 m-auto">
                <h1 className="text-center">Vehicle Creation</h1>
                <div className="row p-3 border shadow-lg rounded-3">
            ...
            {showText === "own" ? <Text response={information} /> : <Text2 />}

            {payload ? (
              showText === "own" ? (
                <Vehicle1dc response={information} />
              ) : (
                <Pltabledc response={information3pl} />
              )
            ) : (
      ...
      >
        ...
        <div className="container p-3">
          <form>
            ...
            {/*<option value="Uttara DC"></option>*/}
            {/*<option value="Banani DC"></option>*/}
            {/*<option value="Jatrabari DC"></option>*/}
            {/*<option value="Mirpur DC"></option>*/}
            {/*<option value="Mohamadpur DC"></option>*/}
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-6 position-relative">
                ...
                >
                  {`Creation Address : ${vehicleCreatedAt}`}
                </p>
              </div>
            </div>
            {/*  */}
...
const Text2 = () => {
  ...
  [bookingnumber, setbookingnumber] = useState("");
...
export default Vehiclecreatedc;
