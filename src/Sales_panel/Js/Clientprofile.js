  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/salesPanelClientInformation" +
          "?company_name=" +
          company_name
        : "/universalapi/allapi/salesPanelClientInformation" +
          "?company_name=" +
          company_name,
      headers: {
      ...
      <div className="bodydiv">
        ...
        <div className="mt-5 pt-5 container">
          <div className="col-12 pt-5" id="">
            {payload ? (
              <Clienttable response={information} />
            ) : (
