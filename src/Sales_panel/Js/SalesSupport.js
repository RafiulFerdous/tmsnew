...
import Supportsales from "../../Model/Sales_content/Supportsales";
  ...
  useEffect(() => {
    ...
    var config = {
      ...
      url: Degital_Ocean_flag
        ? "https://e-deshdelivery.com/universalapi/allapi/salesPanelClientSupport" +
          "?company_name=" +
          company_name
        : "/universalapi/allapi/salesPanelClientSupport" +
          "?company_name=" +
          company_name,
      headers: {
          ...
          <div>
            ...
            <div className="mt-5 pt-5 container">
              <div className="col-12 pt-5 d-flex" id="">
                {payload ? (
                  <Supportsales response={information} />
                ) : (
