...
const Salesproduct = () => {
  ...
  //   var config = {
  //     method: 'post',
  //     url: Degital_Ocean_flag ? 'https://e-deshdelivery.com/universalapi/allapi/salesPanelProduct_information'+'?company_name='+company_name : '/universalapi/allapi/salesPanelProduct_information'+'?company_name='+company_name,
  //     headers: {
          ...
          <div>
            ...
            <div className="mt-5 pt-5 container">
              <div className="col-12 pt-5 d-flex" id="">
                {payload ? (
                  <ProductInformation response={information} />
                ) : (
